# Code from: https://github.com/aqeelanwar/Snake-And-Apple/
...
class SnakeAndApple:
    ...
    #################################################################
    #################################################################
    ### CGT TODO: use this function to create a green and a red apple
    #################################################################
    #################################################################
    ...
    def update_snake(self, key):
        ...
        #################################################################
        #################################################################
        ### CGT TODO: use the following key directions for creating a
        ###           function with direct and inverse snake movement
        ### CGT TODO: add the key input update functionality here
        #################################################################
        #################################################################
        tail = self.snake[0]
        head = self.snake[-1]
    ...
    def check_if_key_valid(self, key):
        #################################################################
        #################################################################
        ### CGT TODO: add an extra valid key input here
        ###           possible keys to be used, can be found here:
